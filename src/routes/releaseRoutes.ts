...
router.post('/releases', authenticateArtist, releaseController.createRelease.bind(releaseController));

// Get all releases for authenticated artist
router.get('/releases', authenticateArtist, releaseController.getReleases.bind(releaseController));

// Get release details
router.get('/releases/:id', authenticateArtist, releaseController.getReleaseDetails.bind(releaseController));

// Update release details
router.put('/releases/:id', authenticateArtist, releaseController.updateRelease.bind(releaseController));

// Delete release
router.delete('/releases/:id', authenticateArtist, releaseController.deleteRelease.bind(releaseController));

// Upload track to release
router.post(
  '/releases/:id/tracks',
  uploadAudio.single('track'), authenticateArtist,
...
router.post(
  '/releases/:id/artwork',
  uploadArtwork.single('artwork'), authenticateArtist,
